...
df$fe_ct <- interaction(df$country, df$time_fe) # μ_ct
df$fe_pt <- interaction(df$party, df$time_fe) # μ_pt

fe_str <- paste(c("fe_i", "fe_ct", "fe_pt"), collapse = " + ")
...
full_formula_str <- paste0("questions_infered_topic_agriculture  ~ meetings_l_agriculture + questions_infered_topic_economics_and_trade + questions_infered_topic_education + questions_infered_topic_environment_and_climate + questions_infered_topic_foreign_and_security_affairs + questions_infered_topic_health + questions_infered_topic_human_rights + questions_infered_topic_infrastructure_and_industry + questions_infered_topic_technology + ", controls_str, " | ", fe_str)
...
m_ddd_ols <- feols(
  full_formula,
  data    = df,
  cluster = ~member_id # two-way clustering: by member and by domain×time
)
...
full_formula_str_squared <- paste0("questions_infered_topic_agriculture ~ meetings_l_agriculture + meetings_l_agriculture**2 + questions_infered_topic_economics_and_trade + questions_infered_topic_education + questions_infered_topic_environment_and_climate + questions_infered_topic_foreign_and_security_affairs + questions_infered_topic_health + questions_infered_topic_human_rights + questions_infered_topic_infrastructure_and_industry + questions_infered_topic_technology + ", controls_str, " | ", fe_str)
