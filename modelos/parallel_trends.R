...
# PNG
png("Tese/figures/fig_parallel_trends_event_study_qtr_year.png", width = 10, height = 6, units = "in", res = 300)
iplot(m_sa_ppml_restricted, ref.line = 0)
title(main = "Event study with staggered adoption (PPML, quarter time, yearly cohorts)")
dev.off()
# PDF
pdf("Tese/figures/fig_parallel_trends_event_study_qtr_year.pdf", width = 10, height = 6)
iplot(m_sa_ppml_restricted, ref.line = 0)
title(main = "Event study with staggered adoption (PPML, quarter time, yearly cohorts)")
dev.off()
...
ggsave("Tese/figures/fig_parallel_trends_event_study_qtr_year_ggplot.pdf", p_event_study, width = 10, height = 6)
ggsave("Tese/figures/fig_parallel_trends_event_study_qtr_year_ggplot.png", p_event_study, width = 10, height = 6, dpi = 300)
