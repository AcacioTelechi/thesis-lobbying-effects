...
% ct
% ​
%  : This fixed effect absorbs any unobserved shocks or characteristics that affect all parliamentarians within a specific country at a given time. For example, a major national event or a change in a country's economic policy.

% τ 
% pt
% ​
%  : This fixed effect accounts for trends or common behaviors that are specific to a particular political party over time. For instance, a party's shift in ideology or a change in its leadership.

% λ 
% dt
% ​
%  : This fixed effect controls for factors that influence parliamentary behavior within a specific policy domain (e.g., healthcare, defense) at a given time. This could include a new international agreement or a major technological advancement in that field.
