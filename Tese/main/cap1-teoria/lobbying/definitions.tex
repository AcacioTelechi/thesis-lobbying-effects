...
% As atividades dos grupos de interesse são moldadas por fatores relacionados às políticas, tais como a complexidade, a saliência, o grau de conflito e os contexto institucional da tomada de decisão \cite{kluver2015legislative}.
...
Além disso, grandes grupos de interesse organizados e grupos que são apoiados por grandes corporações têm maior chance de fazer lobby em comparação a grupos menores \cite{de_figueiredo_advancing_2014}. 
% Essas evidências foram encontradas em diversos setores para o caso norte-americano (Ansolabehere et al. 2002, Hansen et al. 2004, Guo 2009, Hochberg et al. 2009, Richter et al. 2009, Hill et al. 2013). Evidências similares também são encontradas para temas tarifários e disputas comerciais \cite{bombardini2012competition}.
...
% \textbf{Instituições formais e informais}
% ver North,1990 in \cite{font_legislative_2023}

% \textbf{Normas} onceptualization of rules as formal and informal prescriptions specifying the actions that are required and permitted, as well as the incentives and constraints for individuals’ behaviour (North, 1990; Ostrom, 1986). in \cite{font_legislative_2023}

% Drawing from conceptualizations of legitimacy (see Benhabib, 1994; Eriksen, 2005; Scharpf, 1998) and theoretical work on information-access (Austen-Smith, 1993; Farrel \& Rabin, 1996) \cite{coen2019legislative}
